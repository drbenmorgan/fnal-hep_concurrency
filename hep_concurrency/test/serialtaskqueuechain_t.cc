...
void SerialTaskQueueChain_test::testPush()
{
  ...
  std::vector<std::shared_ptr<hep::concurrency::SerialTaskQueue>> queues = {std::make_shared<hep::concurrency::SerialTaskQueue>(), std::make_shared<hep::concurrency::SerialTaskQueue>()};
...
void SerialTaskQueueChain_test::testPushOne()
{
  ...
  std::vector<std::shared_ptr<hep::concurrency::SerialTaskQueue>> queues = {std::make_shared<hep::concurrency::SerialTaskQueue>()};
  hep::concurrency::SerialTaskQueueChain chain(queues);
  {
    std::shared_ptr<tbb::task> waitTask{new (tbb::task::allocate_root()) tbb::empty_task{},
      [](tbb::task* iTask){tbb::task::destroy(*iTask);} };
